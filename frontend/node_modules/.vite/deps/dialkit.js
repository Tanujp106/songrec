...
var DialStoreClass = class {
  ...
  updatePanel(id, name, config) {
    ...
    for (const [path, mode] of Object.entries(existing.values)) {
      ...
      if ((transitionControl == null ? void 0 : transitionControl.type) === "transition") {
  ...
  subscribe(panelId, listener) {
    ...
    return () => {
      var _a;
      (_a = this.listeners.get(panelId)) == null ? void 0 : _a.delete(listener);
    };
  }
  ...
  subscribeActions(panelId, listener) {
    ...
    return () => {
      var _a;
      (_a = this.actionListeners.get(panelId)) == null ? void 0 : _a.delete(listener);
    };
  }
  triggerAction(panelId, path) {
    var _a;
    (_a = this.actionListeners.get(panelId)) == null ? void 0 : _a.forEach((fn) => fn(path));
  }
  ...
  notify(panelId) {
    var _a;
    (_a = this.listeners.get(panelId)) == null ? void 0 : _a.forEach((fn) => fn());
  }
  notifyGlobal() {
...
function useDialKit(name, config, options) {
  ...
  const onActionRef = (0, import_react.useRef)(options == null ? void 0 : options.onAction);
  ...
  (0, import_react.useEffect)(() => {
    return DialStore.subscribeActions(panelId, (action) => {
      var _a;
      (_a = onActionRef.current) == null ? void 0 : _a.call(onActionRef, action);
    });
  }, [panelId]);
...
function Folder({ title, children, defaultOpen = true, isRoot = false, inline = false, onOpenChange, toolbar }) {
  const [isOpen, setIsOpen] = (0, import_react5.useState)(defaultOpen);
  const [isCollapsed, setIsCollapsed] = (0, import_react5.useState)(!defaultOpen);
  const contentRef = (0, import_react5.useRef)(null);
  const [contentHeight, setContentHeight] = (0, import_react5.useState)(void 0);
  ...
  const folderContent = (0, import_jsx_runtime.jsxs)("div", { ref: isRoot ? contentRef : void 0, className: `dialkit-folder ${isRoot ? "dialkit-folder-root" : ""}`, children: [
    (0, import_jsx_runtime.jsxs)("div", { className: `dialkit-folder-header ${isRoot ? "dialkit-panel-header" : ""}`, onClick: handleToggle, children: [
      (0, import_jsx_runtime.jsxs)("div", { className: "dialkit-folder-header-top", children: [
        isRoot ? isOpen && (0, import_jsx_runtime.jsx)("div", { className: "dialkit-folder-title-row", children: (0, import_jsx_runtime.jsx)("span", { className: "dialkit-folder-title dialkit-folder-title-root", children: title }) }) : (0, import_jsx_runtime.jsx)("div", { className: "dialkit-folder-title-row", children: (0, import_jsx_runtime.jsx)("span", { className: "dialkit-folder-title", children: title }) }),
        isRoot && !inline && (0, import_jsx_runtime.jsxs)(
          "svg",
          {
            ...
            children: [
              ...
              (0, import_jsx_runtime.jsx)("circle", { cx: "6", cy: "8", r: "0.998596", fill: "currentColor", stroke: "currentColor", strokeWidth: "1.25" }),
              (0, import_jsx_runtime.jsx)("circle", { cx: "10.4999", cy: "3.5", r: "0.998657", fill: "currentColor", stroke: "currentColor", strokeWidth: "1.25" }),
              (0, import_jsx_runtime.jsx)("circle", { cx: "9.75015", cy: "12.5", r: "0.997986", fill: "currentColor", stroke: "currentColor", strokeWidth: "1.25" })
            ]
          }
        ),
        !isRoot && (0, import_jsx_runtime.jsx)(
          motion.svg,
          {
            ...
            children: (0, import_jsx_runtime.jsx)("path", { d: "M6 9.5L12 15.5L18 9.5" })
          }
        )
      ] }),
      isRoot && toolbar && isOpen && (0, import_jsx_runtime.jsx)("div", { className: "dialkit-panel-toolbar", onClick: (e) => e.stopPropagation(), children: toolbar })
    ] }),
    (0, import_jsx_runtime.jsx)(AnimatePresence, { initial: false, children: isOpen && (0, import_jsx_runtime.jsx)(
      motion.div,
      {
        ...
        children: (0, import_jsx_runtime.jsx)("div", { className: "dialkit-folder-inner", children })
      }
    ) })
  ] });
  if (isRoot) {
    if (inline) {
      return (0, import_jsx_runtime.jsx)("div", { className: "dialkit-panel-inner dialkit-panel-inline", children: folderContent });
    }
...
function Slider({
  ...
  return (0, import_jsx_runtime2.jsx)("div", { ref: wrapperRef, className: "dialkit-slider-wrapper", children: (0, import_jsx_runtime2.jsxs)(
    motion.div,
    {
      ref: trackRef,
      ...
      children: [
        (0, import_jsx_runtime2.jsx)("div", { className: "dialkit-slider-hashmarks", children: hashMarks }),
        ...
        (0, import_jsx_runtime2.jsx)("span", { ref: labelRef, className: "dialkit-slider-label", children: label }),
        showInput ? (0, import_jsx_runtime2.jsx)(
          "input",
          {
            ref: inputRef,
            type: "text",
...
function SegmentedControl({
  ...
  const buttonRefs = (0, import_react9.useRef)(/* @__PURE__ */ new Map());
  ...
  return (0, import_jsx_runtime3.jsxs)("div", { ref: containerRef, className: "dialkit-segmented", children: [
    pillStyle && (0, import_jsx_runtime3.jsx)(
      motion.div,
      {
...
function Toggle({ label, checked, onChange }) {
  return (0, import_jsx_runtime4.jsxs)("div", { className: "dialkit-labeled-control", children: [
    (0, import_jsx_runtime4.jsx)("span", { className: "dialkit-labeled-control-label", children: label }),
...
function SpringVisualization({ spring, isSimpleMode }) {
  ...
  for (let i = 1; i < 4; i++) {
    ...
    const y = height / 4 * i;
    gridLines.push(
      (0, import_jsx_runtime5.jsx)("line", { x1: x, y1: 0, x2: x, y2: height, stroke: "rgba(255, 255, 255, 0.08)", strokeWidth: "1" }, `v-${i}`),
      (0, import_jsx_runtime5.jsx)("line", { x1: 0, y1: y, x2: width, y2: y, stroke: "rgba(255, 255, 255, 0.08)", strokeWidth: "1" }, `h-${i}`)
    );
  }
  return (0, import_jsx_runtime5.jsxs)("svg", { viewBox: `0 0 ${width} ${height}`, className: "dialkit-spring-viz", children: [
    gridLines,
...
function SpringControl({ panelId, path, label, spring, onChange }) {
  const mode = (0, import_react11.useSyncExternalStore)(
  ...
  return (0, import_jsx_runtime6.jsx)(Folder, { title: label, defaultOpen: true, children: (0, import_jsx_runtime6.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: [
    (0, import_jsx_runtime6.jsx)(SpringVisualization, { spring, isSimpleMode }),
    (0, import_jsx_runtime6.jsxs)("div", { className: "dialkit-labeled-control", children: [
      (0, import_jsx_runtime6.jsx)("span", { className: "dialkit-labeled-control-label", children: "Type" }),
    ...
    isSimpleMode ? (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
      (0, import_jsx_runtime6.jsx)(
        Slider,
        {
          label: "Duration",
  ...
  return (0, import_jsx_runtime7.jsxs)(
    "svg",
    {
      ...
      children: [
        ...
        (0, import_jsx_runtime7.jsx)("path", { d: curvePath, fill: "none", stroke: "rgba(255, 255, 255, 0.6)", strokeWidth: "2", strokeLinecap: "round" })
      ]
    }
  );
}
function TransitionControl({ panelId, path, label, value, onChange }) {
  const mode = (0, import_react12.useSyncExternalStore)(
    (cb) => DialStore.subscribe(panelId, cb),
  ...
  return (0, import_jsx_runtime8.jsx)(Folder, { title: label, defaultOpen: true, children: (0, import_jsx_runtime8.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: [
    isEasing ? (0, import_jsx_runtime8.jsx)(EasingVisualization, { easing }) : (0, import_jsx_runtime8.jsx)(SpringVisualization, { spring, isSimpleMode: isSimpleSpring }),
    (0, import_jsx_runtime8.jsxs)("div", { className: "dialkit-labeled-control", children: [
      (0, import_jsx_runtime8.jsx)("span", { className: "dialkit-labeled-control-label", children: "Type" }),
    ...
    isEasing ? (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
      (0, import_jsx_runtime8.jsx)(Slider, { label: "x1", value: easing.ease[0], onChange: (v) => updateEase(0, v), min: 0, max: 1, step: 0.01 }),
      (0, import_jsx_runtime8.jsx)(Slider, { label: "y1", value: easing.ease[1], onChange: (v) => updateEase(1, v), min: -1, max: 2, step: 0.01 }),
      (0, import_jsx_runtime8.jsx)(Slider, { label: "x2", value: easing.ease[2], onChange: (v) => updateEase(2, v), min: 0, max: 1, step: 0.01 }),
      (0, import_jsx_runtime8.jsx)(Slider, { label: "y2", value: easing.ease[3], onChange: (v) => updateEase(3, v), min: -1, max: 2, step: 0.01 }),
      (0, import_jsx_runtime8.jsx)(Slider, { label: "Duration", value: easing.duration, onChange: (v) => onChange({ ...easing, duration: v }), min: 0.1, max: 2, step: 0.05, unit: "s" }),
      (0, import_jsx_runtime8.jsx)(EaseTextInput, { ease: easing.ease, onChange: (newEase) => onChange({ ...easing, ease: newEase }) })
    ] }) : isSimpleSpring ? (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
      (0, import_jsx_runtime8.jsx)(Slider, { label: "Duration", value: spring.visualDuration ?? 0.3, onChange: (v) => handleSpringUpdate("visualDuration", v), min: 0.1, max: 1, step: 0.05, unit: "s" }),
      (0, import_jsx_runtime8.jsx)(Slider, { label: "Bounce", value: spring.bounce ?? 0.2, onChange: (v) => handleSpringUpdate("bounce", v), min: 0, max: 1, step: 0.05 })
    ] }) : (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
      (0, import_jsx_runtime8.jsx)(Slider, { label: "Stiffness", value: spring.stiffness ?? 400, onChange: (v) => handleSpringUpdate("stiffness", v), min: 1, max: 1e3, step: 10 }),
      (0, import_jsx_runtime8.jsx)(Slider, { label: "Damping", value: spring.damping ?? 17, onChange: (v) => handleSpringUpdate("damping", v), min: 1, max: 100, step: 1 }),
      (0, import_jsx_runtime8.jsx)(Slider, { label: "Mass", value: spring.mass ?? 1, onChange: (v) => handleSpringUpdate("mass", v), min: 0.1, max: 10, step: 0.1 })
    ] })
  ] }) });
}
...
function EaseTextInput({ ease, onChange }) {
  ...
  return (0, import_jsx_runtime8.jsxs)("div", { className: "dialkit-labeled-control", children: [
    (0, import_jsx_runtime8.jsx)("span", { className: "dialkit-labeled-control-label", children: "Ease" }),
    (0, import_jsx_runtime8.jsx)(
      "input",
      {
        type: "text",
...
function TextControl({ label, value, onChange, placeholder }) {
  return (0, import_jsx_runtime9.jsxs)("div", { className: "dialkit-text-control", children: [
    (0, import_jsx_runtime9.jsx)("label", { className: "dialkit-text-label", children: label }),
...
function SelectControl({ label, value, options, onChange }) {
  ...
  (0, import_react13.useEffect)(() => {
    var _a;
    const root = (_a = triggerRef.current) == null ? void 0 : _a.closest(".dialkit-root");
  ...
  return (0, import_jsx_runtime10.jsxs)("div", { className: "dialkit-select-row", children: [
    (0, import_jsx_runtime10.jsxs)(
      "button",
      {
        ...
        children: [
          (0, import_jsx_runtime10.jsx)("span", { className: "dialkit-select-label", children: label }),
          (0, import_jsx_runtime10.jsxs)("div", { className: "dialkit-select-right", children: [
            (0, import_jsx_runtime10.jsx)("span", { className: "dialkit-select-value", children: (selectedOption == null ? void 0 : selectedOption.label) ?? value }),
            (0, import_jsx_runtime10.jsx)(
              motion.svg,
              {
                ...
                children: (0, import_jsx_runtime10.jsx)("path", { d: "M6 9.5L12 15.5L18 9.5" })
              }
            )
          ] })
        ]
    ...
    portalTarget && (0, import_react_dom2.createPortal)(
      (0, import_jsx_runtime10.jsx)(AnimatePresence, { children: isOpen && pos && (0, import_jsx_runtime10.jsx)(
        motion.div,
        {
          ref: dropdownRef,
          ...
          children: normalized.map((option) => (0, import_jsx_runtime10.jsx)(
            "button",
            {
...
function ColorControl({ label, value, onChange }) {
  ...
  const [editValue, setEditValue] = (0, import_react15.useState)(value);
  const colorInputRef = (0, import_react15.useRef)(null);
  ...
  return (0, import_jsx_runtime11.jsxs)("div", { className: "dialkit-color-control", children: [
    (0, import_jsx_runtime11.jsx)("span", { className: "dialkit-color-label", children: label }),
    (0, import_jsx_runtime11.jsxs)("div", { className: "dialkit-color-inputs", children: [
      isEditing ? (0, import_jsx_runtime11.jsx)(
        "input",
        {
          type: "text",
      ...
      (0, import_jsx_runtime11.jsx)(
        "button",
        {
          ...
          onClick: () => {
            var _a;
            return (_a = colorInputRef.current) == null ? void 0 : _a.click();
          },
          title: "Pick color"
        }
      ),
...
function PresetManager({ panelId, presets, activePresetId, onAdd }) {
  ...
  const [pos, setPos] = (0, import_react16.useState)({ top: 0, left: 0, width: 0 });
  ...
  (0, import_react16.useEffect)(() => {
    ...
    const handler = (e) => {
      var _a, _b;
      const target = e.target;
      if (((_a = triggerRef.current) == null ? void 0 : _a.contains(target)) || ((_b = dropdownRef.current) == null ? void 0 : _b.contains(target))) return;
      close();
    };
  ...
  return (0, import_jsx_runtime12.jsxs)("div", { className: "dialkit-preset-manager", children: [
    (0, import_jsx_runtime12.jsxs)(
      "button",
      {
        ...
        children: [
          (0, import_jsx_runtime12.jsx)("span", { className: "dialkit-preset-label", children: activePreset ? activePreset.name : "Version 1" }),
          (0, import_jsx_runtime12.jsx)(
            motion.svg,
            {
              ...
              transition: { type: "spring", visualDuration: 0.2, bounce: 0.15 },
              children: (0, import_jsx_runtime12.jsx)("path", { d: "M6 9.5L12 15.5L18 9.5" })
            }
          )
        ]
      }
    ...
    (0, import_react_dom3.createPortal)(
      (0, import_jsx_runtime12.jsx)(AnimatePresence, { children: isOpen && (0, import_jsx_runtime12.jsxs)(
        motion.div,
        {
          ref: dropdownRef,
          ...
          children: [
            (0, import_jsx_runtime12.jsx)(
              "div",
              {
                ...
                children: (0, import_jsx_runtime12.jsx)("span", { className: "dialkit-preset-name", children: "Version 1" })
              }
            ),
            presets.map((preset) => (0, import_jsx_runtime12.jsxs)(
              "div",
              {
                className: "dialkit-preset-item",
                ...
                children: [
                  (0, import_jsx_runtime12.jsx)("span", { className: "dialkit-preset-name", children: preset.name }),
                  (0, import_jsx_runtime12.jsx)(
                    "button",
                    {
                      ...
                      title: "Delete preset",
                      children: (0, import_jsx_runtime12.jsxs)("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [
                        (0, import_jsx_runtime12.jsx)("path", { d: "M5 6.5L5.80734 18.2064C5.91582 19.7794 7.22348 21 8.80023 21H15.1998C16.7765 21 18.0842 19.7794 18.1927 18.2064L19 6.5" }),
                        (0, import_jsx_runtime12.jsx)("path", { d: "M10 11V16" }),
                        (0, import_jsx_runtime12.jsx)("path", { d: "M14 11V16" }),
                        (0, import_jsx_runtime12.jsx)("path", { d: "M3.5 6H20.5" }),
                        (0, import_jsx_runtime12.jsx)("path", { d: "M8.07092 5.74621C8.42348 3.89745 10.0485 2.5 12 2.5C13.9515 2.5 15.5765 3.89745 15.9291 5.74621" })
                      ] })
                    }
                  )
                ]
...
function Panel({ panel, defaultOpen = true, inline = false }) {
  ...
  const [isPanelOpen, setIsPanelOpen] = (0, import_react3.useState)(defaultOpen);
  const values = (0, import_react3.useSyncExternalStore)(
...
Apply these values as the new defaults in the useDialKit call.`;
  ...
  const renderControl = (control) => {
    ...
    switch (control.type) {
      ...
      case "folder":
        return (0, import_jsx_runtime13.jsx)(Folder, { title: control.label, defaultOpen: control.defaultOpen ?? true, children: (_a = control.children) == null ? void 0 : _a.map(renderControl) }, control.path);
      case "text":
        return (0, import_jsx_runtime13.jsx)(
          TextControl,
          {
  ...
  const toolbar = (0, import_jsx_runtime13.jsxs)(import_jsx_runtime13.Fragment, { children: [
    (0, import_jsx_runtime13.jsx)(
      motion.button,
      {
        ...
        whileTap: { scale: 0.9 },
        transition: { type: "spring", visualDuration: 0.15, bounce: 0.3 },
        children: (0, import_jsx_runtime13.jsxs)("svg", { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2.5", strokeLinecap: "round", strokeLinejoin: "round", children: [
          (0, import_jsx_runtime13.jsx)("path", { d: "M4 6H20" }),
          (0, import_jsx_runtime13.jsx)("path", { d: "M4 12H10" }),
          (0, import_jsx_runtime13.jsx)("path", { d: "M15 15L21 15" }),
          (0, import_jsx_runtime13.jsx)("path", { d: "M18 12V18" }),
          (0, import_jsx_runtime13.jsx)("path", { d: "M4 18H10" })
        ] })
      }
    ),
    (0, import_jsx_runtime13.jsx)(
    ...
    (0, import_jsx_runtime13.jsxs)(
      motion.button,
      {
        ...
        transition: { type: "spring", visualDuration: 0.15, bounce: 0.3 },
        children: [
          (0, import_jsx_runtime13.jsx)("span", { className: "dialkit-toolbar-copy-icon-wrap", children: (0, import_jsx_runtime13.jsx)(AnimatePresence, { initial: false, mode: "popLayout", children: copied ? (0, import_jsx_runtime13.jsx)(
            motion.svg,
            {
              ...
              children: (0, import_jsx_runtime13.jsx)("path", { d: "M5 12.75L10 19L19 5" })
            },
            "check"
          ) : (0, import_jsx_runtime13.jsxs)(
            motion.svg,
            {
              ...
              transition: { type: "spring", visualDuration: 0.3, bounce: 0.2 },
              children: [
                (0, import_jsx_runtime13.jsx)("path", { d: "M8 6C8 4.34315 9.34315 3 11 3H13C14.6569 3 16 4.34315 16 6V7H8V6Z", stroke: "currentColor", strokeWidth: "2", strokeLinejoin: "round" }),
                ...
                (0, import_jsx_runtime13.jsx)("path", { d: "M16 5H17C18.6569 5 20 6.34315 20 8V11M8 5H7C5.34315 5 4 6.34315 4 8V18C4 19.6569 5.34315 21 7 21H12", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" })
              ]
            },
            "clipboard"
          ) }) }),
  ...
  return (0, import_jsx_runtime13.jsx)("div", { className: "dialkit-panel-wrapper", children: (0, import_jsx_runtime13.jsx)(Folder, { title: panel.name, defaultOpen, isRoot: true, inline, onOpenChange: setIsPanelOpen, toolbar, children: renderControls() }) });
}
function DialRoot({ position = "top-right", defaultOpen = true, mode = "popover" }) {
  ...
  const content = (0, import_jsx_runtime14.jsx)("div", { className: "dialkit-root", "data-mode": mode, children: (0, import_jsx_runtime14.jsx)("div", { className: "dialkit-panel", "data-position": inline ? void 0 : position, "data-mode": mode, children: panels.map((panel) => (0, import_jsx_runtime14.jsx)(Panel, { panel, defaultOpen: inline || defaultOpen, inline }, panel.id)) }) });
  if (inline) {
    return content;
  }
...
function ButtonGroup({ buttons }) {
  return (0, import_jsx_runtime15.jsx)("div", { className: "dialkit-button-group", children: buttons.map((button, index) => (0, import_jsx_runtime15.jsx)(
    "button",
    {
      className: "dialkit-button",
